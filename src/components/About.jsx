      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white/30 dark:bg-black/30 backdrop-blur-xl rounded-[32px] p-8 border border-white/50 dark:border-white/10 shadow-xl">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
            This modern weather application provides real-time updates and
            forecasts with a focus on premium user experience and aesthetics.
            Built with React, Tailwind CSS, and OpenWeather API.
          </p>
