...
function App() {
  ...
  return (
    <div className={`min-h-screen w-full bg-gradient-to-br ${getBackground()} transition-colors duration-1000 p-4 sm:p-8 flex items-center justify-center font-sans relative overflow-hidden`}>
      ...
      <button 
        onClick={toggleTheme}
        className="absolute top-4 right-4 sm:top-8 sm:right-8 bg-white/20 dark:bg-black/40 backdrop-blur-md border border-white/50 dark:border-white/10 p-3 rounded-full shadow-lg text-gray-800 dark:text-yellow-400 hover:scale-110 transition-transform z-50"
